...
function twoArrays(k, A, B) {
    // Didn't get the full solution
    // Easier to sort A biggest to smallest then B smallest to biggest
    //   then have something like A[i] + B[i] >= k

    /*
    I saw someone sort smallest to biggest with below, not sure how this logically works tho
    arrayOfIntegers.sort(function (first, second) {
        return first - second;
    });
    or
    arrayOfIntegers.sort((first, second) => {
        return first - second;
    });
    */
